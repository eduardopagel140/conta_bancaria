...
export function main() {
    ...
    while (true) {
        ...
        try {
            ...
            console.log(colors.fg.red, "Ocorreu um erro inesperado:", error, colors.reset);
        }
    }
...
function sobre(): void {
    ...
    console.log("Eduardo Pagel - eduardo_pagel@hotmail.com");
    console.log("github.com/eduardopagel140");
    console.log("*****************************************************");
}
